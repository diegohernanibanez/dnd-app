...
export const CONJUROS = {
  ...
  'Adivinación': {
    ...
    alcance: 'Lanzador',
    componentes: 'V, S, M (incienso que valga al menos 25 po, que se consume en el lanzamiento)',
    duracion: 'Instantáneo',
  ...
  'Alzar a los Muertos': {
    ...
    alcance: 'Toque',
    componentes: 'V, S, M (un diamante que valga al menos 500 po)',
    duracion: 'Instantáneo',
...
La criatura vuelve a la vida con 1 punto de golpe. El conjuro también neutraliza cualquier veneno que afectase a la criatura en el momento de su muerte. Este conjuro cierra todas las heridas mortales, pero no devuelve las partes del cuerpo que faltan. Si a la criatura le faltan partes del cuerpo u órganos fundamentales para que sobreviva (por ejemplo, la cabeza), el conjuro falla automáticamente. Regresar de entre los muertos es una experiencia complicada. El objetivo tendrá un penalizador de -4 a las pruebas con d20. Cada vez que finalice un descanso largo, el penalizador se reduce en 1 hasta desaparecer.`
  ...
  'Animar a los Muertos': {
    ...
    alcance: '3 m',
    componentes: 'V, S, M (una gota de sangre, un pedazo de carne y una pizca de hueso)',
    duracion: 'Instantáneo',
  ...
  'Antipatía/Simpatía': {
    ...
    duracion: '10 días',
    descripcion: `Mientras lanzas el conjuro, elige si crea antipatía o simpatía y haz objetivo a una criatura u objeto de tamaño Enorme o más pequeño. A continuación, selecciona un tipo de criatura, como dragones rojos, goblins o vampiros. Las criaturas del tipo elegido harán una tirada de salvación de Sabiduría cuando se acerquen a 36 m o menos del objetivo. La elección de antipatía o simpatía determina lo que le sucede a una criatura si falla la salvación:
Antipatía. La criatura tiene el estado de asustada y deberá utilizar su movimiento en sus turnos para alejarse lo máximo posible del objetivo por la ruta más segura.
Simpatía. La criatura tiene el estado de hechizada y deberá utilizar su movimiento en sus turnos para acercarse lo máximo posible al objetivo por la ruta más segura. Si la criatura se encuentra a 1,5 m o menos del objetivo, no podrá alejarse de él voluntariamente. Si el objetivo daña a la criatura hechizada, esta puede hacer una tirada de salvación de Sabiduría para poner fin al efecto, como se describe a continuación.
Poner fin al efecto. Si la criatura asustada o hechizada termina su turno a más de 36 m del objetivo, deberá hacer una tirada de salvación de Sabiduría. Si la supera, dejará de verse afectada por el objetivo. Las criaturas que superen la tirada de salvación contra este efecto serán inmunes a él durante 1 minuto y después podrán verse afectadas otra vez.`
  },
  'Apariencia': {
    nivel: 5,
    escuela: 'Ilusionismo',
...
Con un espacio de conjuro de nivel superior. El daño aumenta en 1d8 por cada nivel por encima de 2 que tenga el espacio.`
  ...
  'Armadura de Agathys': {
    ...
    duracion: '1 hora',
    descripcion: `Una escarcha mágica protectora te rodea y ganas 5 puntos de golpe temporales. Si una criatura te acierta con una tirada de ataque cuerpo a cuerpo antes de que el conjuro termine, dicha criatura sufre 5 de daño de frío. El conjuro termina antes de tiempo si no tienes puntos de golpe temporales.
Con un espacio de conjuro de nivel superior. Los puntos de golpe temporales y el daño de frío aumentan en 5 por cada nivel por encima de 1 que tenga el espacio.`
  ...
  'Atadura Planar': {
    ...
    tiempoLanzamiento: '1 hora',
    alcance: '18 m',
    componentes: 'V, S, M (una joya que valga al menos 1.000 po)',
    duracion: '24 horas',
  ...
  'Augurio': {
    ...
    tiempoLanzamiento: '1 minuto o un ritual',
    alcance: 'Lanzador',
    componentes: 'V, S, M (palitos, huesos, cartas u otros abalorios de adivinación que valgan al menos 25 po)',
    duracion: 'Instantáneo',
    descripcion: `Obtienes un presagio de una entidad de otro mundo sobre los resultados de un curso de acción que planees llevar a cabo en los próximos 30 minutos. Tu DM elige el presagio de la siguiente tabla.\n\nPRESAGIOS\nPresagio | Para los resultados que sean...\nFortuna | Buenos\nDesdicha | Malos\nFortuna y desdicha | Buenos y malos\nIndiferencia | Ni buenos ni malos\n\nEl conjuro no tiene en cuenta las circunstancias que puedan alterar los resultados, como lanzar otros conjuros. Si lanzas el conjuro más de una vez antes de finalizar un descanso largo, hay una posibilidad acumulativa del 25 % por cada lanzamiento después del primero de que no recibas ninguna respuesta.`
  },
  ...
  'Aura Sagrada': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Lanzador',
    componentes: 'V, S, M (un relicario que valga al menos 1.000 po que contenga material sagrado)',
    duracion: 'Concentración, hasta 1 minuto',
...
Si la falla, tendrá el estado de hechizado hasta que termine el conjuro. Mientras esté hechizado, el objetivo bailará de forma cómica, empleará todo su movimiento para bailar en el sitio y tendrá desventaja en las tiradas de ataque y de salvación de Destreza, y otras criaturas tendrán ventaja en las tiradas de ataque contra él. En cada uno de sus turnos, el objetivo puede usar una acción para recuperar el control y repetir la tirada de salvación. Si la supera, el conjuro termina`
  ...
  'Bendición': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '9 m',
    componentes: 'V, S, M (un símbolo sagrado que valga al menos 5 po)',
    duracion: 'Concentración, hasta 1 minuto',
  ...
  'Boca Mágica': {
    ...
    tiempoLanzamiento: '1 minuto o un ritual',
    alcance: '9 m',
    componentes: 'V, S, M (polvo de jade que valga al menos 10 po)',
  ...
  'Bola de Fuego': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '45 m',
    componentes: 'V, S, M (una pelota de guano de murciélago y azufre)',
    duracion: 'Instantáneo',
...
Mejora de truco. El daño aumenta en 1d6 cuando alcanzas los niveles 5 (2d6), 11 (3d6) y 17 (4d6).`
  ...
  'Calmar Emociones': {
    ...
    componentes: 'V, S',
    duracion: 'Concentración, hasta 1 minuto',
    descripcion: `Cada humanoide en una esfera de 6 m de radio centrada en un punto que elijas dentro del alcance deberá superar una tirada de salvación de Carisma o se verá afectado por uno de los siguientes efectos (elige uno por cada criatura):
...
+ La criatura se vuelve indiferente hacia las criaturas de tu elección hacia las que sea hostil. Esta indiferencia termina si el objetivo recibe daño o si observa cómo alguno de sus aliados resulta dañado. Cuando el conjuro termine, la actitud de la criatura volverá a la normalidad.`
  ...
  'Cambiar de Forma': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Lanzador',
    componentes: 'V, S, M (una diadema de jade que valga al menos 1.500 po)',
    duracion: 'Concentración, hasta 1 hora',
  ...
  'Castigo Divino': {
    ...
    componentes: 'V',
    duracion: 'Instantáneo',
    descripcion: `El objetivo sufre 2d8 de daño radiante adicional del ataque. Este daño aumenta en 1d8 si el objetivo es un infernal o un muerto viviente.
Con un espacio de conjuro de nivel superior. El daño aumenta en 1d8 por cada nivel por encima de 1 que tenga el espacio.`
  ...
  'Cautiverio': {
    ...
    tiempoLanzamiento: '1 minuto',
    alcance: '9 m',
    componentes: 'V, S, M (una estatuilla del objetivo que valga al menos 1.500 po, tallada de jaspe o piedra de alabastro)',
    duracion: 'Hasta que sea disipado',
...
Presidio cercado. El objetivo está atrapado en un semiplano protegido contra la teletransportación y el viaje interplanar. El semiplano puede ser un laberinto, una jaula, una torre o una estructura similar. Sueño. El objetivo tiene el estado de inconsciente y no se le puede despertar. Poner fin al conjuro. Cuando lances el conjuro, especifica una condición que le ponga fin. Puede ser tan sencilla o complicada como quieras, aunque tu DM debe estar de acuerdo en que tenga una alta probabilidad de llegar a ocurrir en la próxima década. La condición debe ser una acción observable, como que alguien haga una ofrenda concreta en el templo de tu dios, salve a tu amor verdadero o derrote a un monstruo concreto. Un conjuro disipar magia puede poner fin al conjuro solamente si se lanza con un espacio de conjuro de nivel 9 y hace objetivo a la prisión o al componente usado para crearla`
  ...
  'Cerradura Arcana': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (polvo de oro que valga al menos 25 po)',
    duracion: 'Hasta que sea disipado',
  ...
  'Clarividencia': {
    ...
    tiempoLanzamiento: '10 minutos',
    alcance: '1,5 km',
    componentes: 'V, S, M (un canalizador que valga al menos 100 po)',
    duracion: 'Concentración, hasta 10 minutos',
  ...
  'Clon': {
    ...
    tiempoLanzamiento: '1 hora',
    alcance: 'Toque',
    componentes: 'V, S, M (un diamante que valga al menos 1.000 po, que se consume, y un recipiente de vidrio o cristal sellado que valga al menos 2.000 po, suficientemente grande para contener una criatura de tamaño Mediano)',
    duracion: 'Instantáneo',
  ...
  'Cofre Oculto de Leomund': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (un cofre con unas dimensiones de hasta 90 cm × 60 cm × 60 cm y una réplica en miniatura de marfil que valga al menos 50 po)',
    duracion: 'Hasta que sea disipado',
...
+ Ubicaciones de masas de agua. Por ejemplo, podrías determinar el paradero de un monstruo poderoso en la zona y la ubicación de masas de agua y de cualquier pueblo cercano`
  ...
  'Conocer las Leyendas': {
    ...
    tiempoLanzamiento: '10 minutos',
    alcance: 'Lanzador',
    componentes: 'V, S, M (incienso que valga al menos 250 po, que se consume en el lanzamiento)',
    duracion: 'Instantáneo',
  ...
  'Consagrar': {
    ...
    alcance: 'Toque',
    componentes: 'V, S, M (incienso que valga al menos 1.000 po, que se consume en el lanzamiento)',
    duracion: 'Hasta que sea disipado',
...
El objetivo deberá repetir la tirada de salvación al final de cada uno de sus turnos hasta que la supere o la falle tres veces. Si supera tres de estas tiradas, el conjuro terminará para el objetivo, pero si falla tres tiradas, el conjuro le durará 7 días. Cuando el objetivo envenenado reciba un efecto que fuera a poner fin al estado de envenenado, deberá superar una tirada de salvación de Constitución o el estado de envenenado no terminará`
  ...
  'Contingencia': {
    ...
    tiempoLanzamiento: '10 minutos',
    alcance: 'Lanzador',
    componentes: 'V, S, M (una estatuilla de ti tallada y decorada con gemas que valga al menos 1.500 po)',
    duracion: '10 días',
    descripcion: `Elige un conjuro de nivel 5 o inferior que puedas lanzar, que tenga un tiempo de lanzamiento de acción y que puedas elegirte como objetivo. Lo lanzas como parte del lanzamiento de Contingencia y gastas los espacios de conjuro de ambos, aunque el conjuro contingente no te afectará en ese momento, sino que se activa cuando se produce una condición determinada. Describe esa condición cuando lanzas los dos conjuros. Por ejemplo, si llevas puesto un conjuro de respirar bajo el agua, podrías decir que el conjuro contingente tenga efecto cuando te sumerjas en agua o en un líquido similar. El conjuro contingente solo tiene efecto sobre ti, aunque normalmente pudieras elegir como objetivo a otros. Solo puede estar activo un conjuro contingente al mismo tiempo. Si vuelves a lanzarlo, terminará el efecto de cualquier otro conjuro contingente que tengas. Asimismo, Contingencia termina si dejas de tener contigo su componente material.`
  },
  'Contorno Borroso': {
    nivel: 2,
    escuela: 'Ilusionismo',
...
Hasta que termine el conjuro, tú o una criatura de tu elección podéis montar el corcel. El corcel utiliza el perfil del caballo de monta (consulta el apéndice B), excepto que tiene una velocidad de 30 m y puede desplazarse a 20 km/h. Cuando el conjuro termina, el corcel se desvanece gradualmente, lo que da al jinete 1 minuto para desmontar. El conjuro termina antes si el corcel recibe daño`
  ...
  'Crear Comida y Agua': {
    ...
    componentes: 'V, S',
    duracion: 'Instantáneo',
    descripcion: `Creas 22,5 kg de comida y 120 l de agua potable en el suelo o en recipientes dentro del alcance, ideales para evitar los peligros de la desnutrición y la deshidratación. La comida es sosa pero nutritiva y tiene el aspecto de una comida de tu elección, mientras que el agua está limpia. La comida se estropea si no se consume en 24 horas`
  },
  'Crear Llama': {
    nivel: 0,
    escuela: 'Conjuración',
  ...
  'Crear Muerto Viviente': {
    ...
    tiempoLanzamiento: '1 minuto',
    alcance: '3 m',
    componentes: 'V, S, M (un ónice negro que valga al menos 150 po por cuerpo)',
    duracion: 'Instantáneo',
...
Curación instantánea. Permites que hasta veinte criaturas que puedas ver y tú recuperéis todos los puntos de golpe y pones fin a todos los efectos que sufráis descritos en el conjuro restablecimiento mayor. Resistencia. Concedes resistencia a un tipo de daño de tu elección a hasta diez criaturas que puedas ver. La resistencia es permanente. Inmunidad a conjuros. Concedes inmunidad a un único conjuro u otro efecto mágico durante 8 horas a hasta diez criaturas que puedas ver. Aprendizaje repentino. Sustituyes una de tus dotes por otra para la que cumplas los requisitos. Pierdes todos los beneficios de la dote anterior y obtienes los de la nueva. No puedes sustituir una dote que funcione como requisito para cualquiera de tus otras dotes o rasgos. Rehacer tiradas. Deshaces un solo suceso reciente obligando a repetir cualquier tirada hecha durante el último asalto (incluido tu último turno). La realidad se reconforma para amoldarse al nuevo resultado. Por ejemplo, un conjuro deseo podría deshacer una tirada de salvación que falle un aliado o un crítico de un enemigo. Puedes obligar a que la tirada se repita con ventaja o desventaja y elegir si usar el nuevo resultado o el resultado original. Remodelar la realidad. Puedes desear algo que no se incluya entre los efectos anteriores. Para ello, explícale tu deseo de la forma más precisa posible a tu DM, quien tiene una amplia capacidad para decidir lo que ocurre en estos casos: cuanto mayor sea el deseo, más posible es que algo vaya mal. El conjuro simplemente podría fallar, el efecto que deseas podría conseguirse solo parcialmente o podrías sufrir una consecuencia imprevisible debido a cómo has expresado tu deseo. Por ejemplo, desear que un villano estuviera muerto podría propulsarte hacia delante en el tiempo hasta un periodo en el que dicho villano ya no esté vivo, lo que te excluiría del juego. De forma similar, desear un objeto mágico legendario o un artefacto podría transportarte de inmediato ante el actual propietario de dicho objeto. Si se te concede el deseo y sus efectos tienen consecuencias para toda una comunidad, región o mundo, es probable que te ganes enemigos poderosos. Si el deseo afectase a un dios, sus sirvientes divinos podrían intervenir al momento para impedirlo o para animarte a que formules el deseo de una forma concreta. Si tu deseo fuese a deshacer el propio multiverso, poner en peligro la ciudad de Sigil o afectar a la Señora del Dolor de algún modo, verás una imagen de ella en tu mente por un momento, negará con la cabeza y el deseo fallará. La tensión de lanzar deseo para producir cualquier efecto que no sea duplicar otro conjuro te debilita. Tras soportar dicha tensión, cada vez que lances un conjuro hasta que finalices un descanso largo, recibirás 1d10 de daño necrótico por cada nivel de ese conjuro. Este daño no se puede reducir ni prevenir de ningún modo. Además, tu puntuación de Fuerza se convierte en 3 durante 2d4 días. Por cada uno de esos días que pases descansando y haciendo únicamente actividades ligeras, tu tiempo de recuperación restante se reduce en 2 días. Por último, hay un 33 % de probabilidad de que no puedas volver a lanzar nunca deseo si sufres esta tensión.`
  ...
  'Despertar': {
    ...
    alcance: 'Toque',
    componentes: 'V, S, M (un ágata que valga al menos 1.000 po)',
    duracion: 'Instantáneo',
  ...
  'Desplazamiento Entre Planos': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (una vara de metal con forma de diapasón ajustada a un plano específico, que valga al menos 250 po)',
    duracion: 'Instantáneo',
  ...
  'Dulce Descanso': {
    ...
    tiempoLanzamiento: 'Acción o ritual',
    alcance: 'Toque',
    componentes: 'V, S, M (2 piezas de cobre, que se consumen en el lanzamiento, y una pizca de sal)',
    duracion: '10 días',
  ...
  'Encontrar Familiar': {
    ...
    alcance: '3 m',
    componentes: 'V, S, M (incienso para quemar que valga al menos 10 po, que se consume en el lanzamiento)',
    duracion: 'Instantáneo',
...
Desaparición del familiar. Si los puntos de golpe del familiar se reducen a 0, desaparecerá y reaparecerá después de que vuelvas a lanzar este conjuro. Como acción de magia, puedes hacer que el familiar se retire temporalmente a una dimensión de bolsillo. Como alternativa, puedes hacer que se desvanezca para siempre. Como acción de magia mientras esté desaparecido temporalmente, puedes hacer que reaparezca en un espacio sin ocupar a 9 m o menos de ti. Siempre que sus puntos de golpe se reduzcan a 0 o que el familiar se retire a la dimensión de bolsillo, dejará en el espacio que ocupaba cualquier cosa que vistiera o llevase. Un solo familiar. No puedes tener más de un familiar al mismo tiempo. Si lanzas este conjuro mientras tengas un familiar, harás que adopte una nueva forma que cumpla los requisitos`
  ...
  'Encontrar el Camino': {
    ...
    tiempoLanzamiento: '1 minuto',
    alcance: 'Lanzador',
    componentes: 'V, S, M (un juego de herramientas de adivinación que valgan al menos 100 po)',
...
Con un espacio de conjuro de nivel superior. El daño aumenta en 1d6 por cada nivel por encima de 2 que tenga el espacio`
  ...
  'Espada de Mordenkainen': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '27 m',
    componentes: 'V, S, M (una espada en miniatura que valga al menos 250 po)',
    duracion: 'Concentración, hasta 1 minuto',
  ...
  'Festín de Héroes': {
    ...
    tiempoLanzamiento: '10 minutos',
    alcance: 'Lanzador',
    componentes: 'V, S, M (un cuenco incrustado de gemas que valga al menos 1.000 po, que se consume en el lanzamiento)',
    duracion: 'Instantáneo',
  ...
  'Flecha de Relámpago': {
    ...
    componentes: 'V, S',
    duracion: 'Instantáneo',
    descripcion: `Cuando tu ataque contra el objetivo acierte o falle, el arma o la munición que usas se transforma en un relámpago. En vez de sufrir daño u otros efectos del ataque, el objetivo recibe 4d8 de daño de relámpago si el ataque acierta o la mitad de daño si falla. Todas las criaturas a 3 m o menos del objetivo harán después una tirada de salvación de Destreza; sufrirán 2d8 de daño de relámpago si la fallan o la mitad del daño si la superan. Luego, el arma o la munición vuelve a la normalidad.
Con un espacio de conjuro de nivel superior. El daño de los dos efectos del conjuro aumenta en 1d8 por cada nivel por encima de 3 que tenga el espacio`
  },
...
Eres consciente del paso del tiempo y puedes lanzar conjuros sobre ti. Puedes usar 1,5 m de tu movimiento para salir de la piedra por el punto en el que entraste, lo que pone fin al conjuro. Por lo demás, no te puedes mover. Un daño físico menor hecho a la piedra no te afecta, pero su destrucción parcial o un cambio en su forma (de manera que ya no quepas en ella) te expulsa y te causa 6d6 de daño de fuerza. La destrucción completa de la piedra (o su transmutación en una sustancia distinta) te expulsa de ella y te inflige 50 de daño de fuerza. Si eres expulsado, te mueves al espacio sin ocupar más cercano junto al punto en el que entraste en ella y tendrás el estado de derribado`
  ...
  'Glifo Custodio': {
    ...
    tiempoLanzamiento: '1 hora',
    alcance: 'Toque',
    componentes: 'V, S, M (diamante en polvo que valga al menos 200 po)',
...
Cuando inscribes el glifo, decides qué lo activa y eliges si se trata de una runa explosiva o un glifo de conjuro, como se explica a continuación. Establecer el activador. Cuando lances el conjuro, decide qué activará el glifo. En el caso de los glifos inscritos en una superficie, las condiciones que suelen activarlos incluyen tocarlos o situarse sobre ellos, quitar otro objeto que los cubra o acercarse a cierta distancia de ellos. En el caso de los glifos inscritos en un objeto, suelen activarse al abrir el objeto o mirar el glifo. En cuanto un glifo se activa, este conjuro termina. Puedes especificar aún más la condición, de modo que solo las criaturas de ciertos tipos puedan activarlo (por ejemplo, que solo afecte a las aberraciones). También puedes establecer excepciones sobre qué criaturas no activarán el glifo; por ejemplo, las que pronuncien una contraseña. Runa explosiva. Cuando se activa, el glifo estalla con energía mágica en una esfera de 6 m de radio centrada en él. Todas las criaturas situadas en esa zona realizan una tirada de salvación de Destreza. Sufrirán 5d8 de daño de ácido, frío, fuego, relámpago o trueno (el tipo que elijas al crear el glifo) si la fallan o la mitad del daño si la superan. Glifo de conjuro. Puedes almacenar un conjuro preparado de nivel 3 o inferior en el glifo si lo lanzas como parte de la creación de dicho glifo. El conjuro debe tener como objetivo una sola criatura o un área. El conjuro almacenado no tiene ningún efecto inmediato cuando se lanza de esta manera. Cuando el glifo se activa, el conjuro almacenado surte efecto. Si el conjuro tiene un objetivo, elige como dicho objetivo a la criatura que haya activado el glifo. Si afecta a un área, la zona está centrada en esa criatura. Si el conjuro invoca criaturas hostiles o crea objetos o trampas perjudiciales, aparecerán lo más cerca posible del intruso y lo atacarán. Si el conjuro requiere concentración, no terminará hasta alcanzar su duración máxima. Con un espacio de conjuro de nivel superior. El daño de una runa explosiva aumenta en 1d8 por cada nivel por encima de 3 que tenga el espacio. Si creas un glifo de conjuro, puedes almacenar cualquier conjuro de hasta el mismo nivel que el espacio de conjuro que hayas empleado para el glifo custodio`
  ...
  'Guardas y Guardias': {
    ...
    tiempoLanzamiento: '1 hora',
    alcance: 'Toque',
    componentes: 'V, S, M (una vara de plata que valga al menos 10 po)',
    duracion: '24 horas',
    descripcion: `Creas una protección que cubre hasta 250 m² de espacio en el suelo. La zona protegida puede tener hasta 6 m de altura y le das la forma de una zona cuadrada de 15 m de lado, cien cuadrados contiguos de 1,5 m de lado o veinticinco cuadrados contiguos de 3 m de lado.
Cuando lances el conjuro, puedes especificar criaturas individuales que no se verán afectadas por los efectos del conjuro. También puedes designar una contraseña que, cuando se diga en alto a 1,5 m o menos de la zona protegida, hace inmune a sus efectos a quien la dice.
El conjuro crea los efectos indicados a continuación en la zona protegida. Disipar magia no tiene efecto sobre guardas y guardias, pero si se pueden disipar los siguientes efectos. Si se disipan los cuatro, guardas y guardias terminará. Si lanzas el conjuro a diario hasta 365 días en la misma zona, el conjuro durará hasta que se disipen todos sus efectos.
Escaleras. Todas las escaleras de la zona protegida se llenan de telas de araña de arriba abajo, como si estuvieran afectadas por el conjuro telaraña. Mientras dure guardas y guardias, estas telas de araña vuelven a generarse en un plazo de 10 minutos si se destruyen.
Puertas. Todas las puertas de la zona protegida están cerradas de manera mágica, como si estuvieran afectadas por el conjuro cerradura arcana. Además, puedes cubrir hasta 10 puertas con una ilusión para que parezcan simples secciones de pared.
Otro efecto del conjuro. Sitúas uno de los siguientes efectos mágicos dentro de la zona protegida:
· Luces danzantes en cuatro pasillos con un patrón sencillo que las luces reproducirán mientras dure guardas y guardias.
· Boca mágica en dos lugares.
· Nube apestosa en dos lugares (los vapores volverán tras 10 minutos si se dispersan mientras dure guardas y guardias).
· Ráfaga de viento en un pasillo o sala (el viento sopla sin parar mientras dure el conjuro).
· Sugestión en una casilla de 1,5 m de lado, y cualquier criatura que entre en ella recibirá la sugestión mentalmente.`
  },
...
La interacción física con la imagen revela que es una ilusión, ya que las cosas pueden atravesarla. Si una criatura emplea una acción de estudiar para examinar la imagen, puede determinar que es una ilusión si supera una prueba de Inteligencia (Investigación) contra tu CD de salvación de conjuros. Si la criatura descubre que la imagen es una ilusión, no se dejará engañar por ella.`
  ...
  'Impacto Certero': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Lanzador',
    componentes: 'S, M (un arma con la que tengas competencia y que valga al menos 1 po)',
    duracion: 'Instantáneo',
  ...
  'Imponer Maldición': {
    ...
    componentes: 'V, S',
    duracion: 'Concentración, hasta 1 minuto',
    descripcion: `Tocas a una criatura, que deberá superar una tirada de salvación de Sabiduría o quedará maldecida hasta que el conjuro termine. Hasta que se rompa la maldición, el objetivo sufrirá uno de los siguientes efectos a tu elección:
...
Con un espacio de conjuro de nivel superior. Si lanzas este conjuro con un espacio de nivel 4, puedes mantener la concentración en él hasta 10 minutos. Si usas un espacio de nivel 5 o superior, el conjuro no requiere concentración y la duración pasará a ser de 8 horas (espacio de nivel 5 o 6) o de 24 horas (espacio de nivel 7 u 8). Si usas un espacio de conjuro de nivel 9, el conjuro durará hasta que sea disipado`
  ...
  'Indetectable': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (una pizca de diamante en polvo que valga al menos 25 po)',
    duracion: '8 horas',
...
Con un espacio de conjuro de nivel superior. Usa el nivel del espacio de conjuro para determinar el nivel del conjuro en el perfil.`
  ...
  'Invocar Aberración': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '27 m',
    componentes: 'V, S, M (un tentáculo en salmuera y un globo de tinta que valgan al menos 400 po)',
    duracion: 'Concentración, hasta 1 hora',
...
Con un espacio de conjuro de nivel superior. Usa el nivel del espacio de conjuro para determinar el nivel del conjuro en el perfil.`
  ...
  'Invocar Autómata': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '27 m',
    componentes: 'V, S, M (una caja de seguridad que valga al menos 500 po)',
    duracion: 'Concentración, hasta 1 hora',
  ...
  'Invocar Bestia': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '27 m',
    componentes: 'V, S, M (una pluma, un poco de pelaje y cola de pez que valgan al menos 200 po)',
    duracion: 'Concentración, hasta 1 hora',
...
Con un espacio de conjuro de nivel superior. Usa el nivel del espacio de conjuro para determinar el nivel del conjuro en el perfil.`
  ...
  'Invocar Dragón': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '18 m',
    componentes: 'V, S, M (un objeto con la imagen de un dragón que valga al menos 500 po)',
    duracion: 'Concentración, hasta 1 hora',
...
Con un espacio de conjuro de nivel superior. Usa el nivel del espacio de conjuro para determinar el nivel del conjuro en el perfil.`
  ...
  'Invocar Feérico': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '27 m',
    componentes: 'V, S, M (una flor bañada en oro que valga al menos 200 po)',
    duracion: 'Concentración, hasta 1 hora',
...
Con un espacio de conjuro de nivel superior. Usa el nivel del espacio de conjuro para determinar el nivel del conjuro en el perfil.`
  ...
  'Invocar Infernal': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '27 m',
    componentes: 'V, S, M (un vial con sangre que valga al menos 999 po)',
    duracion: 'Concentración, hasta 1 hora',
...
Con un espacio de conjuro de nivel superior. Usa el nivel del espacio de conjuro para determinar el nivel del conjuro en el perfil.`
  ...
  'Invocar Muerto Viviente': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '27 m',
    componentes: 'V, S, M (una calavera bañada en oro que valga al menos 300 po)',
    duracion: 'Concentración, hasta 1 hora',
...
Con un espacio de conjuro de nivel superior. Usa el nivel del espacio de conjuro para determinar el nivel del conjuro en el perfil.`
  ...
  'Jaula de Fuerza': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: '30 m',
    componentes: 'V, S, M (polvo de rubí que valga al menos 1.500 po)',
    duracion: 'Concentración, hasta 1 hora',
  ...
  'Llama Permanente': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (polvo de rubí que valga al menos 50 po)',
    duracion: 'Hasta que sea disipado',
  ...
  'Mal de Ojo': {
    ...
    componentes: 'V, S',
    duracion: 'Concentración, hasta 1 minuto',
    descripcion: `Hasta que el conjuro termine, tus ojos se convierten en un vacío oscuro. Una criatura de tu elección que puedas ver a 18 m o menos de ti deberá superar una tirada de salvación de Sabiduría o se verá afectada por uno de los efectos descritos debajo, a tu elección, hasta que termine el conjuro.
En cada uno de tus turnos hasta que el conjuro termine, puedes usar una acción de magia para hacer objetivo a otra criatura, pero no puedes volver a elegir a una que haya superado una tirada de salvación contra este lanzamiento del conjuro.
Náuseas. El objetivo tiene el estado de envenenado.
Pánico. El objetivo tiene el estado de asustado. En cada uno de sus turnos, el objetivo asustado deberá realizar la acción de correr para alejarse de ti por la ruta más corta y segura disponible. Si se mueve a un espacio que esté al menos a 18 m de ti donde no pueda verte, el efecto termina.
Sueño. El objetivo tiene el estado de inconsciente. Se despertará si recibe algún daño o si otra criatura utiliza una acción para despertarlo.`
  },
  'Maleficio': {
    nivel: 1,
    escuela: 'Encantamiento',
...
El personal de servicio está compuesto de 100 sirvientes casi transparentes que atienden a todos los que entran. Tú decides la apariencia y el atuendo de estos sirvientes, que son invulnerables y obedecen tus órdenes. Los sirvientes pueden realizar las tareas que haría un humano, pero no pueden atacar ni realizar ninguna acción que dañaría directamente a otra criatura. Por lo tanto, pueden traer y llevar cosas, limpiar, arreglar y plegar ropa, encender fuegos, servir comida y vino, etc, aunque no pueden abandonar el lugar. Cuando el conjuro termina, todas las criaturas u objetos que queden en el espacio extradimensional son expulsados a los espacios sin ocupar más cercanos a la entrada`
  ...
  'Manto del Cruzado': {
    ...
    componentes: 'V',
    duracion: 'Concentración, hasta 1 minuto',
    descripcion: `Irradias un aura mágica en una emanación de 9 m. Mientras permanezcáis dentro, tus aliados y tú causaréis 1d4 de daño radiante adicional cuando acertéis con un arma o un ataque sin armas.`
  },
  'Marca del Cazador': {
    nivel: 1,
    escuela: 'Adivinación',
...
Si sacas el mismo número en dos o más de los d8, el orbe salta a otro objetivo distinto de tu elección que esté a 9 m o menos del objetivo. Haz una tirada de ataque contra el nuevo objetivo y otra tirada de daño. El orbe no puede volver a saltar, a menos que lances el conjuro con un espacio de nivel 2 o superior. Con un espacio de conjuro de nivel superior. El daño aumenta en 1d8 por cada nivel por encima de 1 que tenga el espacio. El orbe puede saltar un máximo de veces igual al nivel del espacio gastado. Una criatura solo puede ser el objetivo una vez por cada lanzamiento del conjuro`
  ...
  'Palabra de Curación en Masa': {
    ...
    componentes: 'V',
    duracion: 'Instantáneo',
    descripcion: `Hasta seis criaturas de tu elección que puedas ver dentro del alcance recuperan una cantidad de puntos de golpe igual a 2d4 más tu modificador por aptitud mágica.
...
Apareces en un punto de tu elección a 1,5 m o menos del árbol de destino gastando otros 1,5 m de movimiento. Si no te queda movimiento, apareces a 1,5 m o menos del árbol en el que entraste. Puedes usar esta capacidad de transporte solo una vez en cada uno de tus turnos y debes terminar cada turno fuera de un árbol.`
  ...
  'Piedad con los Moribundos': {
    ...
    componentes: 'V, S',
    duracion: 'Instantáneo',
    descripcion: `Elige a una criatura dentro del alcance que tenga 0 puntos de golpe y no esté muerta. La criatura pasa a estar estable. Mejora de truco. El alcance se duplica cuando alcanzas los niveles 5 (9 m), 11 (18 m) y 17 (36 m)`
  },
  'Piel Pétrea': {
    nivel: 4,
    escuela: 'Transmutación',
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (polvo de diamante que valga al menos 100 po)',
    duracion: 'Concentración, hasta 1 hora',
...
Efecto sensorial. Creas un efecto sensorial instantáneo e inofensivo, como una lluvia de chispas, una ligera ráfaga de viento, tenues notas musicales o un olor extraño. Jugar con fuego. Enciendes o apagas al instante una vela, una antorcha o una hoguera pequeña. Limpiar o ensuciar. Limpias o ensucias al instante un objeto de hasta 0,03 m³. Sensación menor. Enfrías, calientas o das sabor a un material inerte de hasta 0,03 m³ durante 1 hora. Marca mágica. Haces que aparezca una mancha de color, una pequeña marca o un símbolo en un objeto o superficie durante 1 hora. Creación menor. Creas un abalorio no mágico o una imagen ilusoria que te cabe en la mano y dura hasta el final de tu siguiente turno. El abalorio no inflige daño y no tiene valor monetario`
  ...
  'Prohibición': {
    ...
    alcance: 'Toque',
    componentes: 'V, S, M (polvo de rubí que valga al menos 1.000 po)',
    duracion: '1 día',
    descripcion: `Creas una protección contra los viajes mágicos que cubre una zona del suelo de 4.000 m² hasta una altura de 9 m. Hasta que termine el conjuro, ninguna criatura podrá teletransportarse a esa zona ni entrar en ella usando portales, como los creados por el conjuro portal. El conjuro protege la zona frente al viaje interplanar, por lo que impide que cualquier criatura entre en el área mediante el Plano Astral, el Plano Etéreo, los Parajes Feéricos, el Páramo Sombrío o el conjuro desplazamiento entre planos. Además, el conjuro daña a los tipos de criaturas que elijas al lanzarlo. Elige uno o más de los siguientes: aberraciones, celestiales, elementales, feéricos, infernales y muertos vivientes. Cuando una criatura de un tipo elegido entre en la zona del conjuro por primera vez en un turno o termine su turno allí, recibirá 5d10 de daño radiante o necrótico (a tu elección cuando lanzas el conjuro). Puedes designar a una criatura específica cuando lanzas el conjuro. Si una criatura pronuncia la contraseña al entrar en el área, no recibirá daño del conjuro.
La zona del conjuro no se puede solaponerse con la de otro conjuro prohibición. Si lanzas prohibición todos los días durante 30 días en la misma ubicación, el conjuro dura hasta que sea disipado y los componentes materiales se consumirán en el último lanzamiento.`
  },
  ...
  'Protección Contra el Bien y el Mal': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (un frasco de agua bendita que valga al menos 25 po)',
    duracion: 'Concentración, hasta 10 minutos',
  ...
  'Proyección Astral': {
    ...
    tiempoLanzamiento: '1 hora',
    alcance: '3 m',
    componentes: 'V, S, M (por cada objetivo del conjuro, una jacinto que valga al menos 1.000 po y una barra de plata que valga al menos 100 po)',
    duracion: 'Hasta que sea disipado',
...
Una forma astral puede viajar a través del Plano Astral. Si abandona el plano, el cuerpo y las posesiones del objetivo viajan a través del cordón de plata, permitiéndole volver a entrar en su cuerpo en el nuevo plano. El daño y otros efectos que se le apliquen a una forma astral no afectan al cuerpo del objetivo y viceversa. Si los puntos de golpe del cuerpo del objetivo o de su forma astral se reducen a 0, el conjuro terminará para él. El conjuro termina para todos los objetivos si empleas una acción de magia para ponerle fin. Cuando el conjuro termine para un'objetivo que no esté muerto, reaparecerá en su cuerpo y concluirá su animación suspendida`
  },
  'Proyectar Imagen': {
    nivel: 7,
    escuela: 'Ilusionismo',
  ...
  'Rayo Abrasador': {
    ...
    componentes: 'V, S',
    duracion: 'Instantáneo',
    descripcion: `Lanzas tres rayos ardientes y los arrojas contra uno o varios objetivos dentro del alcance. Haz un ataque de conjuro a distancia por cada rayo. Si acierta, el objetivo recibe 2d6 de daño de fuego.
Con un espacio de conjuro de nivel superior. Creas un rayo adicional por cada nivel por encima de 2 que tenga el espacio`
  },
  'Rayo Debilitador': {
    nivel: 2,
    escuela: 'Nigromancia',
...
Mejora de truco. El daño aumenta en 1d8 cuando alcanzas los niveles 5 (2d8), 11 (3d8) y 17 (4d8).`
  ...
  'Recluir': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (polvo de piedras preciosas que valga al menos 5.000 po, que se consume en el lanzamiento)',
    duracion: 'Hasta que sea disipado',
  ...
  'Reencarnar': {
    ...
    tiempoLanzamiento: '1 hora',
    alcance: 'Toque',
    componentes: 'V, S, M (aceites raros que valgan al menos 1.000 po, que el conjuro consume)',
    duracion: 'Instantáneo',
  ...
  'Relámpago': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Lanzador',
    componentes: 'V, S, M (un poco de pelaje y una vara de vidrio, ámbar o cristal)',
    duracion: 'Instantáneo',
  ...
  'Restablecimiento Mayor': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (polvo de diamante que valga al menos 100 po, que se consume en el lanzamiento)',
    duracion: 'Instantáneo',
    descripcion: `Tocas a una criatura y eliminas mágicamente uno de los siguientes efectos de ella:
...
+ Cualquier reducción de los puntos de golpe máximos del objetivo`
  ...
  'Resurrección': {
    ...
    tiempoLanzamiento: '1 hora',
    alcance: 'Toque',
    componentes: 'V, S, M (un diamante que valga al menos 1.000 po)',
    duracion: 'Instantáneo',
  ...
  'Resurrección Verdadera': {
    ...
    tiempoLanzamiento: '1 hora',
    alcance: 'Toque',
    componentes: 'V, S, M (diamantes que valgan al menos 25.000 po)',
    duracion: 'Instantáneo',
  ...
  'Revivir': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (un diamante que valga al menos 300 po)',
    duracion: 'Instantáneo',
  ...
  'Saber Druídico': {
    ...
    componentes: 'V, S',
    duracion: 'Instantáneo',
    descripcion: `Susurras a los espíritus de la naturaleza y produces uno de los siguientes efectos dentro del alcance.
...
Efecto sensorial. Creas un efecto sensorial inofensivo, como hojas cayendo, hadas espectrales bailando, una suave brisa, el sonido de un animal o un leve olor a mofeta. El efecto debe caber en un cubo de 1,5 m de lado.
...
Con un espacio de conjuro de nivel superior. Puedes aumentar el tamaño del cubo en 30 m por cada nivel por encima de 4 que tenga el espacio.`
  ...
  'Simulacro': {
    ...
    alcance: 'Toque',
    componentes: 'V, S, M (rubí en polvo que valga al menos 1.500 po, que se consume en el lanzamiento)',
    duracion: 'Hasta que sea disipado',
    descripcion: `Creas un simulacro de una bestia o humanoide que permanece a 3 m o menos de ti durante todo el tiempo de lanzamiento del conjuro. Para finalizar el lanzamiento, tocas a la criatura y una pila de hielo o nieve de su mismo tamaño. El hielo da vida al simulacro de la criatura y se convierte en una criatura. El simulacro tendrá el perfil de la criatura original en el momento del lanzamiento, excepto que tiene la mitad de sus puntos de golpe máximos y no puede lanzar este conjuro.
El simulacro es amistoso contigo y con las criaturas que designes, obedece tus órdenes y actúa en tu turno de combate. Además, no puede subir de nivel ni hacer descansos cortos o largos.
Si el simulacro sufre daño, la única forma de restaurar sus puntos de golpe es restaurarlo cuando hagas un descanso largo. En ese momento, puedes gastar componentes con un valor de 100 po por cada punto de golpe recuperado. Para restaurarlo, el simulacro debe permanecer a 1,5 m o menos de ti.
El simulacro dura hasta que sus puntos de golpe se reduzcan a 0, momento en el que se convierte en nieve o hielo y se derrite. Si vuelves a lanzar este conjuro, cualquier simulacro que hayas creado antes con él se destruye al instante.`
  },
  'Sirviente Invisible': {
    nivel: 1,
    escuela: 'Conjuración',
  ...
  'Símbolo': {
    ...
    tiempoLanzamiento: '1 minuto',
    alcance: 'Toque',
    componentes: 'V, S, M (diamante en polvo que valga al menos 1.000 po, que el conjuro consume)',
    duracion: 'Hasta que sea disipado o se active',
  ...
  'Telepatía': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'limitado',
    componentes: 'V, S, M (un par de anillos de plata vinculados por un lazo de cobre)',
    duracion: '24 horas',
  ...
  'Teletransporte': {
    ...
    componentes: 'V',
    duracion: 'Instantáneo',
    descripcion: `Este conjuro os transporta a un destino que elijas a ti y a hasta ocho criaturas voluntarias que puedas ver o a un solo objeto que puedas ver dentro del alcance. Si el objetivo es un objeto, debe ser Grande o más pequeño y no puede llevarlo o vestirlo una criatura no voluntaria. Debes conocer el destino que elijas y también debe estar en el mismo plano de existencia que tú. Lo bien que conoces el destino es decisivo para conseguir llegar a él. Tu DM tira 1d100 y consulta la tabla “Resultado del teletransporte” y las explicaciones que la siguen.\n\nRESULTADO DEL TELETRANSPORTE\nFamiliaridad | Percance | Área similar | Lejos del objetivo | En el objetivo\nCírculo permanente | — | — | — | 01-00\nObjeto vinculado | — | — | — | 01-00\nMuy familiar | 01-05 | 06-13 | 14-24 | 25-00\nVisto esporádicamente | 01-33 | 34-43 | 44-53 | 54-00\nVisto una vez o descrito | 01-43 | 44-53 | 54-73 | 74-00\nDestino falso | 01-50 | 51-00 | — | —\n\nFamiliaridad. Los términos de la columna “Familiaridad” de la tabla significan lo siguiente:
+ “Círculo permanente” se refiere a un círculo de teletransportación permanente cuya secuencia de sellos conozcas.
+ “Objeto vinculado” quiere decir que posees un objeto tomado del destino deseado en los últimos seis meses, como un libro de la biblioteca de un mago.
+ “Muy familiar” es un sitio que has visitado a menudo, que has estudiado detenidamente o que puedas ver cuando lanzas el conjuro.
+ “Visto esporádicamente” es un lugar que has visto más de una vez, pero que no conoces muy bien.
+ “Visto una vez o descrito” es un lugar que solo has visto en una ocasión, quizá mediante la magia, o un sitio que conoces de segunda mano, quizá por un mapa.
+ “Destino falso” es un lugar que no existe. Es posible que trataras de escrudiñar el sanctasanctórum de un enemigo, pero que, en su lugar, vieras una ilusión, o puede que intentes teletransportarte a una ubicación que ya no existe.\nPercance. La magia impredecible del conjuro da como resultado un viaje complicado. Cada criatura que se teletransporta (o el objeto objetivo) recibe 3d10 de daño de fuerza y tu DM vuelve a tirar en la tabla para ver dónde acabáis (se pueden producir varios percances, que causarán daño cada una de las veces).\nÁrea similar. Tu grupo y tú (o el objeto objetivo) aparecéis en una zona diferente pero que se parece visual o temáticamente al área objetivo. Llegaréis al espacio similar más cercano. Por ejemplo, si te dirigías a tu laboratorio, podrías acabar en el laboratorio de otra persona en la misma ciudad.\nLejos del objetivo. Tu grupo y tú (o el objeto objetivo) aparecéis a 2d12 x 1,5 km de distancia del destino en una dirección al azar. Tira 1d8 para determinar la dirección: con un 1, al este; con un 2, al sureste; con un 3, al sur; con un 4, al suroeste; con un 5, al oeste; con un 6, al noroeste; con un 7, al norte, y con un 8, al noreste.\nEn el objetivo. Tu grupo y tú (o el objeto objetivo) aparecéis donde tú querías.`
  },
  ...
  'Terreno Alucinatorio': {
    ...
    duracion: '24 horas',
    descripcion: `Haces que un terreno natural en un cubo de 45 m de lado dentro del alcance tenga el aspecto, los sonidos y los olores de otro tipo de terreno natural. Por ejemplo, puedes hacer que un campo abierto o una carretera se parezcan a un pantano, una colina, una grieta u otro tipo de terreno difícil o infranqueable. Se puede hacer que un estanque parezca una pradera cubierta de hierba, que un precipicio se aparezca como una suave cuesta o que un barranco pedregoso y estrecho se presente como una carretera amplia y lisa. Las estructuras fabricadas, el equipo y las criaturas en la zona no cambian. Las características táctiles del terreno no cambian, por lo que es probable que las criaturas que entren en la zona descubran que es una ilusión. Si la diferencia no es obvia al tacto, cualquier criatura que examine la ilusión puede usar una acción de estudiar y hacer una prueba de Inteligencia (Investigación) contra tu CD de salvación de conjuros para distinguirla. Si la criatura percibe que es una ilusión, la verá como una imagen difusa y superpuesta al terreno de verdad.`
  },
  'Terror': {
    nivel: 3,
    escuela: 'Ilusionismo',
...
|`
  ...
  'Tronar': {
    ...
    componentes: 'S',
    duracion: 'Instantáneo',
    descripcion: `Todas las criaturas situadas en una emanación de 1,5 m que se origina en ti deberán superar una tirada de salvación de Constitución o sufrirán 1d6 de daño de trueno. El sonido atronador del conjuro se puede oír a una distancia de hasta 30 m.\nMejora de truco. El daño aumenta en 1d6 cuando alcanzas los niveles 5 (2d6), 11 (3d6) y 17 (4d6).`
  },
  'Truco de la Cuerda': {
    nivel: 2,
    escuela: 'Transmutación',
  ...
  'Urna Mágica': {
    ...
    tiempoLanzamiento: '1 minuto',
    alcance: 'Lanzador',
    componentes: 'V, S, M (una gema, un cristal o un relicario que valga al menos 500 po)',
    duracion: 'Hasta que sea disipado',
...
Puedes intentar poseer a cualquier humanoide que esté a 30 m o menos de ti que puedas ver (las criaturas protegidas mediante un conjuro círculo mágico o protección contra el bien y el mal no pueden ser poseídas). El objetivo hace una tirada de salvación de Carisma. Si la falla, tu alma se introducirá en el cuerpo del objetivo y la suya quedará atrapada en el recipiente. Si la supera, resistirá tus esfuerzos por poseerlo y no podrás volver a intentarlo durante 24 horas. En cuanto posees el cuerpo de una criatura, lo controlas. Tus puntos de golpe, dados de puntos de golpe, Fuerza, Destreza, Constitución, velocidad y sentidos se sustituyen por los de la criatura. Por lo demás, conservas tu perfil. Por su parte, el alma de la criatura poseída puede percibir desde el recipiente usando sus propios sentidos, pero no puede moverse y tiene el estado de incapacitada. Mientras posees un cuerpo, puedes usar una acción de magia para volver del cuerpo anfitrión al recipiente si está a 30 m o menos de ti, lo que hace que el alma de la criatura anfitriona regrese a su propio cuerpo. Si el cuerpo anfitrión muere mientras estás en él, la criatura muere y tú debes hacer una tirada de salvación de Carisma contra tu propia CD de salvación de conjuros. Si la superas, volverás al recipiente si está a 30 m o menos de ti. De lo contrario, morirás. Si el recipiente es destruido o el conjuro termina, tu alma volverá a tu cuerpo. Si tu cuerpo está a más de 30 m de ti o está muerto, morirás. Si el alma de otra criatura está en el recipiente cuando es destruido, esa alma volverá a su cuerpo, siempre y cuando esté vivo y a30 m o menos de ella. De lo contrario, esa criatura morirá. Cuando el conjuro termine, el recipiente se destruirá`
  ...
  'Visión Veraz': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (hongos pulverizados que valgan al menos 25 po)',
    duracion: '1 hora',
  ...
  'Vínculo Protector': {
    ...
    tiempoLanzamiento: 'Acción',
    alcance: 'Toque',
    componentes: 'V, S, M (un par de anillos de platino que valgan al menos 50 po cada uno, que el conjuro consume)',
    duracion: '1 hora',
  ...
  'Zancada Prodigiosa': {
    ...
    duracion: '1 hora',
    descripcion: `Tocas a una criatura y su velocidad aumenta en 3 m hasta que el conjuro termine.
Con un espacio de conjuro de nivel superior. Puedes hacer objetivo a una criatura adicional por cada nivel por encima de 1 que tenga el espacio.`
  },
  'Zona de la Verdad': {
    nivel: 2,
